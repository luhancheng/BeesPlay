...
- (void)setModel:(AlbumModel *)model {
    if ( _albumModel != model) {
        _albumModel = model ;
    }
    self.headerImage = [[UIImageView alloc] initWithFrame:CGRectMake(10, 10, self.contentView.height - 20, self.contentView.height - 20)];
    ...
    [self addSubview:self.createDateTime];
